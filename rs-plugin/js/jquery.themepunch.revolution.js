...
(function (jQuery, undefined) {
            ...
            try {
              if (jQuery(this).hasClass("video-js") && addedvid == 0) {
                ...
                jQuery("head")
                  .find("*")
                  .each(function () {
                    if (jQuery(this).attr("src") == opt.videoJsPath + "video.js") loadit = false;
                  });
                if (loadit) {
  ...
  function containerResized(container, opt) {
    ...
    nextsh.find(".defaultimg").each(function () {
      ...
      if (dimg.data("kenburn") != undefined) dimg.data("kenburn").restart();
    });
  ...
  function prepareOneSlideSlot(slotholder, opt, visible, vorh) {
    ...
    if (vorh == "horizontal") {
      ...
      for (var i = 0; i < opt.slots; i++) {
        ...
        if (scalestart != undefined && rotatestart != undefined) TweenLite.set(sh.find(".slot").last(), { rotationZ: rotatestart });
        if (isIE(8)) {
          sh.find(".slot ")
            .last()
            .find(".slotslide")
            .append('<img class="ieeightfallbackimage" src="' + imgsrc + '" style="width:100%">');
  ...
  function ieimgposition(nextsh, opt) {
    if (isIE(8)) {
      ...
      if (nextsh.data("bgposition") == "center center") ie8img.css({ position: "absolute", top: opt.height / 2 - ie8h / 2 + "px", left: opt.width / 2 - ie8w / 2 + "px" });

      if (nextsh.data("bgposition") == "center top" || nextsh.data("bgposition") == "top center") ie8img.css({ position: "absolute", top: "0px", left: opt.width / 2 - ie8w / 2 + "px" });

      if (nextsh.data("bgposition") == "center bottom" || nextsh.data("bgposition") == "bottom center") ie8img.css({ position: "absolute", bottom: "0px", left: opt.width / 2 - ie8w / 2 + "px" });

      if (nextsh.data("bgposition") == "right top" || nextsh.data("bgposition") == "top right") ie8img.css({ position: "absolute", top: "0px", right: "0px" });

      if (nextsh.data("bgposition") == "right bottom" || nextsh.data("bgposition") == "bottom right") ie8img.css({ position: "absolute", bottom: "0px", right: "0px" });

      if (nextsh.data("bgposition") == "right center" || nextsh.data("bgposition") == "center right") ie8img.css({ position: "absolute", top: opt.height / 2 - ie8h / 2 + "px", right: "0px" });

      if (nextsh.data("bgposition") == "left bottom" || nextsh.data("bgposition") == "bottom left") ie8img.css({ position: "absolute", bottom: "0px", left: "0px" });

      if (nextsh.data("bgposition") == "left center" || nextsh.data("bgposition") == "center left") ie8img.css({ position: "absolute", top: opt.height / 2 - ie8h / 2 + "px", left: "0px" });
    }
  }
  ...
  function swapSlideProgress(container, opt) {
    ...
    if (nextsh.data("kenburns") == "on") stopKenBurn(container, opt);
    ...
    if (nexttrans == 8) {
      ...
      actsh.find(".slotslide").each(function () {
        ...
        TweenLite.to(ss, masterspeed / 1000, { left: 0 - opt.width / 2 + "px", top: 0 - opt.sloth / 2 + "px", width: opt.width * 2 + "px", height: opt.sloth * 2 + "px", transformPerspective: 600, opacity: 0, rotation: opt.rotate });
      });
    ...
    if (nexttrans == 12 || nexttrans == 13 || nexttrans == 14 || nexttrans == 15) {
      ...
      if (specials != 1) {
        if (nexttrans == 12) TweenLite.to(ssa, speedy2, { left: 0 - oow + "px", scale: scal, opacity: op, rotation: opt.rotate, ease: easeitout });
        else if (nexttrans == 15) TweenLite.to(ssa, speedy2, { left: oow + "px", scale: scal, opacity: op, rotation: opt.rotate, ease: easeitout });
        else if (nexttrans == 13) TweenLite.to(ssa, speedy2, { top: 0 - ooh + "px", scale: scal, opacity: op, rotation: opt.rotate, ease: easeitout });
        else if (nexttrans == 14) TweenLite.to(ssa, speedy2, { top: ooh + "px", scale: scal, opacity: op, rotation: opt.rotate, ease: easeitout });
      }
    ...
    if (nexttrans == 16) {
      ...
      if (actli.html() != null) TweenLite.fromTo(nextli, (masterspeed - 200) / 1000, { opacity: 0, scale: 0.8, x: opt.width * xof, y: ooh * yof, rotation: ro3, transformPerspective: 600, transformOrigin: "center center" }, { rotation: 0, scale: 1, x: 0, y: 0, opacity: 1, ease: Power2.easeInOut });
  ...
  function stopKenBurn(container, opt) {
    ...
    nextsh.find(".defaultimg").each(function () {
      ...
      if (defimg.data("kenburn") != undefined) defimg.data("kenburn").restart();
  ...
  function startKenBurn(container, opt) {
    ...
    var bgps = nextsh.data("bgposition"),
    ...
    nextsh.find(".defaultimg").each(function () {
      ...
      defimg.data(
        ...
        TweenLite.fromTo(
          defimg,
          dur,
          { transformPerspective: 1200, backgroundSize: bgfs, z: 0, backgroundPosition: bgps, rotationZ: ros },
          {
            yoyo: 2,
            rotationZ: roe,
            ease: easeme,
  ...
  function letItFree(container, opt, nextsh, actsh, nextli, actli) {
    ...
    opt.act = opt.next;
    moveSelectedThumb(container);
    if (nextsh.data("kenburns") == "on") startKenBurn(container, opt);
  }
  ...
  function html5vidready(myPlayer, player_id) {
    ...
    myPlayer.on("play", function () {
      if (player_cont.closest(".tp-caption").data("volume") == "mute") myPlayer.volume(0);
    ...
    myPlayer.on("loadedmetadata", function (data) {
      ...
      for (var prop in this) {
        try {
          if (this[prop].hasOwnProperty("videoWidth")) videoWidth = this[prop].videoWidth;

          if (this[prop].hasOwnProperty("videoHeight")) videoHeight = this[prop].videoHeight;
        } catch (e) {}
      }
      ...
      if (player_cont.closest(".tp-caption").data("forcecover") == 1) updateHTML5Size(player_cont, container);
    });
  }
  /////////////////////////////////////
  ...
  function updateHTML5Size(pc, container) {
    ...
    if (windowAspect < mediaAspect) {
      ...
      pc.css("top", -(windowW / mediaAspect - windowH) / 2)
        .css("left", 0)
  ...
  function animateTheCaptions(nextli, opt, recalled) {
    ...
    nextli.find(".tp-caption").each(function (i) {
      ...
      if (handlecaption == 0) {
        ...
        if (nextcaption.find("iframe").length > 0 || nextcaption.find("video").length > 0) {
          ...
          if (nextcaption.find("video").length > 0) {
            nextcaption.find("video").each(function (i) {
              ...
              if (html5vid.closest(".tp-caption").data("forcecover") == 1) updateHTML5Size(html5vid, opt.container);

              var htmlint = setInterval(function () {
                if (typeof videojs != undefined && typeof videojs != "undefined") var html5vid = nextcaption.find("video").parent();
                ...
                if (html5vid != undefined && html5vid.hasClass("video-js")) {
                  ...
                  if (nextcaption.data("autoplay") == true) {
                    ...
                    videojs(videoID).ready(function () {
                      ...
                      if (html5vid.data("loadedmetadata") == 1 || html5vid.data("canplay") == 1) if (nextcaption.data("forcerewind") == "on") myPlayer.currentTime(0);

                      html5vid.data(
                        "timerplay",
                        setTimeout(function () {
                          if (html5vid.data("loadedmetadata") == 1 || html5vid.data("canplay") == 1) {
                            if (nextcaption.data("forcerewind") == "on") myPlayer.currentTime(0);

                            if (html5vid.closest(".tp-caption").data("volume") == "mute") myPlayer.volume(0);
                          }
                          setTimeout(function () {
                            myPlayer.play(0);
        ...
        else var calcy = opt.bh * nextcaption.data("y") + offsety;
        ...
        if (!recalled) {
          ...
          function tlstart() {
            nextcaption.data(
              "timer",
              setTimeout(function () {
                if (nextcaption.hasClass("fullscreenvideo")) nextcaption.css({ display: "block" });
              }, nextcaption.data("start"))
            );
          }
          ...
          if (opt.fullScreenAlignForce == "on") calcy = nextcaption.data("y") + offsety;

          var animobject = nextcaption;
          if (nextcaption.data("mySplitText") != undefined) nextcaption.data("mySplitText").revert();

          if (nextcaption.data("splitin") == "chars" || nextcaption.data("splitin") == "words" || nextcaption.data("splitin") == "lines" || nextcaption.data("splitout") == "chars" || nextcaption.data("splitout") == "words" || nextcaption.data("splitout") == "lines") {
            if (nextcaption.find("a").length > 0) nextcaption.data("mySplitText", new SplitText(nextcaption.find("a"), { type: "lines,words,chars", charsClass: "tp-splitted", wordsClass: "tp-splitted", linesClass: "tp-splitted" }));
            else nextcaption.data("mySplitText", new SplitText(nextcaption, { type: "lines,words,chars", charsClass: "tp-splitted", wordsClass: "tp-splitted", linesClass: "tp-splitted" }));
          ...
          if (nextcaption.hasClass("customin")) {
            if (animobject != nextcaption) tl.add(TweenLite.set(nextcaption, { opacity: 1, scaleX: 1, scaleY: 1, rotationX: 0, rotationY: 0, rotationZ: 0, skewX: 0, skewY: 0, z: 0, x: 0, y: 0, visibility: "visible", opacity: 1, delay: 0, overwrite: "all" }));
  ...
  function countDown(container, opt) {
    ...
    if (opt.slideamount > 1 && !(opt.stopAfterLoops == 0 && opt.stopAtSlide == 1)) {
      ...
      opt.cdint = setInterval(function () {
        ...
        if (opt.conthover != 1 && opt.videoplaying != true && opt.width > opt.hideSliderAtLimit && opt.bannertimeronpause != true && opt.overnav != true) opt.cd = opt.cd + 50;

        TweenLite.to(bt, 0.3, { width: (opt.cd / opt.delay) * 100 + "%" });

        if (opt.fullWidth != "on")
          if (opt.width > opt.hideSliderAtLimit) container.parent().removeClass("tp-hide-revslider");
      ...
      container.hover(
        function () {
          if (opt.onHoverStop == "on") {
            ...
            nextsh.find(".defaultimg").each(function () {
              var dimg = jQuery(this);
              if (dimg.data("kenburn") != undefined) dimg.data("kenburn").pause();
            });
          }
        },
        function () {
          if (container.data("conthover") != 1) {
            ...
            nextsh.find(".defaultimg").each(function () {
              var dimg = jQuery(this);
              if (dimg.data("kenburn") != undefined) dimg.data("kenburn").play();
            });
          }
        }
      );
    ...
    g = function (t, e, i, s, o) {
      ...
      for (f = 0; j > f; f++)
        (y = v[f]),
          (_ = y.parentNode === t),
          "BR" !== y.nodeName
            ? (D && ((b = y.style), R || _ || ((y._x += y.parentNode._x), (y._y += y.parentNode._y)), (b.left = y._x + "px"), (b.top = y._y + "px"), (b.position = "absolute"), (b.display = "block"), (b.width = y._w + 1 + "px"), (b.height = y._h + "px")), R ? (_ ? s.push(y) : A && i.push(y)) : _ ? (t.removeChild(y), v.splice(f--, 1), j--) : !_ && A && ((T = !k && !D && y.nextSibling), t.appendChild(y), T || t.appendChild(n.createTextNode(" ")), i.push(y)))
            : k || D
