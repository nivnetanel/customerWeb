...
(function (t, e) {
  ...
  (i.defaults = { stop_browser_behavior: { userSelect: "none", touchAction: "none", touchCallout: "none", contentZooming: "none", userDrag: "none", tapHighlightColor: "rgba(0,0,0,0)" } }),
  ...
  (i.event = {
    ...
    collectEventData: function (t, e, n) {
      var r = this.getTouchList(n, e),
        o = i.POINTER_TOUCH;
      return (
        (n.type.match(/mouse/) || i.PointerEvent.matchType(i.POINTER_MOUSE, n)) && (o = i.POINTER_MOUSE),
        {
    ...
    d("Ticker", function (t, e) {
      var i,
        ...
        f = function (t) {
          ...
          var e,
            n = h.time - l;
          (!i || n > 0 || t === !0) && (h.frame++, (l += n + (n >= o ? 0.004 : o - n)), (e = !0)), t !== !0 && (r = s(f)), e && h.dispatchEvent("tick");
        };
      y.call(h),
        (h.time = h.frame = 0),
        (h.tick = function () {
      ...
      (r.render = function (t, e, i) {
        ...
        if (t >= l) (this._totalTime = this._time = l), (this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || ((s = !0), (r = "onComplete")), 0 === l && ((a = this._rawPrevTime), (0 === t || 0 > a || a === h) && a !== t && ((i = !0), a > h && (r = "onReverseComplete")), (this._rawPrevTime = a = !e || t || 0 === a ? t : h));
          ...
          var _ = t / l,
            u = this._easeType,
            m = this._easePower;
          (1 === u || (3 === u && _ >= 0.5)) && (_ = 1 - _), 3 === u && (_ *= 2), 1 === m ? (_ *= _) : 2 === m ? (_ *= _ * _) : 3 === m ? (_ *= _ * _ * _) : 4 === m && (_ *= _ * _ * _ * _), (this.ratio = 1 === u ? 1 - _ : 2 === u ? _ : 0.5 > t / l ? _ / 2 : 1 - _ / 2);
        ...
        if (this._time !== o || i) {
          ...
          this._onUpdate && (0 > t && this._startAt && this._startTime && this._startAt.render(t, e, i), e || ((this._time !== o || s) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || g))),
    ...
    function (t, e, i) {
      ...
      return (
        ...
        (u.staggerTo = function (t, e, r, a, o, l, u, p) {
          var f,
            c = new s({ onComplete: l, onCompleteParams: u, onCompleteScope: p, smoothChildTiming: this.smoothChildTiming });
        ...
        (u.render = function (t, e, i) {
          ...
          if (
            (t >= _
              ? ((this._totalTime = this._time = _), this._reversed || this._hasPausedChild() || ((n = !0), (h = "onComplete"), 0 === this._duration && (0 === t || 0 > this._rawPrevTime || this._rawPrevTime === r) && this._rawPrevTime !== t && this._first && ((l = !0), this._rawPrevTime > r && (h = "onReverseComplete"))), (this._rawPrevTime = this._duration || !e || t || 0 === this._rawPrevTime ? t : r), (t = _ + 1e-4))
              : 1e-7 > t
              ? ((this._totalTime = this._time = 0), (0 !== u || (0 === this._duration && (this._rawPrevTime > r || (0 > t && this._rawPrevTime >= 0)))) && ((h = "onReverseComplete"), (n = this._reversed)), 0 > t ? ((this._active = !1), 0 === this._duration && this._rawPrevTime >= 0 && this._first && (l = !0), (this._rawPrevTime = t)) : ((this._rawPrevTime = this._duration || !e || t || 0 === this._rawPrevTime ? t : r), (t = 0), this._initted || (l = !0)))
        ...
        (i = h(
          ...
          function (e) {
            ...
            for (var i, s, r, n, a, o, h = e.taper || "none", l = [], _ = 0, u = 0 | (e.points || 20), p = u, f = e.randomize !== !1, m = e.clamp === !0, d = e.template instanceof t ? e.template : null, g = "number" == typeof e.strength ? 0.4 * e.strength : 0.4; --p > -1; )
              (i = f ? Math.random() : (1 / u) * p), (s = d ? d.getRatio(i) : i), "none" === h ? (r = g) : "out" === h ? ((n = 1 - i), (r = n * n * g)) : "in" === h ? (r = i * i * g) : 0.5 > i ? ((n = 2 * i), (r = 0.5 * n * n * g)) : ((n = 2 * (1 - i)), (r = 0.5 * n * n * g)), f ? (s += Math.random() * r - 0.5 * r) : p % 2 ? (s += 0.5 * r) : (s -= 0.5 * r), m && (s > 1 ? (s = 1) : 0 > s && (s = 0)), (l[_++] = { x: i, y: s });
            for (
              l.sort(function (t, e) {
                return t.x - e.x;
              }),
    ...
    function (t, e) {
      ...
      var h,
        ...
        Q = function (t, e, i, r, s) {
          ...
          return (
            h && (i = -i),
            "%" === r && -1 !== e.indexOf("border") ? (n = (i / 100) * (a ? t.clientWidth : t.clientHeight)) : ((l.cssText = "border:0 solid red;position:" + H(t, "position") + ";line-height:0;"), "%" !== r && o.appendChild ? (l[a ? "borderLeftWidth" : "borderTopWidth"] = i + r) : ((o = t.parentNode || X.body), (l[a ? "width" : "height"] = i + r)), o.appendChild(I), (n = parseFloat(I[a ? "offsetWidth" : "offsetHeight"])), o.removeChild(I), 0 !== n || s || (n = Q(t, e, i, r, !0))),
            h ? -n : n
          );
        },
        Z = function (t, e, i) {
        ...
        $ = function (t, e) {
          var i,
            ...
            s = {};
          if ((e = e || q(t, null)))
            if ((i = e.length)) for (; --i > -1; ) s[e[i].replace(S, k)] = e.getPropertyValue(e[i]);
        ...
        se = function (t, e, i, r) {
          ...
          return (
            null == t
              ...
              : "number" == typeof t
              ? (o = t)
              : ((s = 360), (n = t.split("_")), (a = Number(n[0].replace(v, "")) * (-1 === t.indexOf("rad") ? 1 : L) - ("=" === t.charAt(1) ? 0 : e)), n.length && (r && (r[i] = e + a), -1 !== t.indexOf("short") && ((a %= s), a !== a % (s / 2) && (a = 0 > a ? a + s : a - s)), -1 !== t.indexOf("_cw") && 0 > a ? (a = ((a + 9999999999 * s) % s) - (0 | (a / s)) * s) : -1 !== t.indexOf("ccw") && a > 0 && (a = ((a - 9999999999 * s) % s) - (0 | (a / s)) * s)), (o = e + a)),
            l > o && o > -l && (o = 0),
            o
          );
        },
            ...
            ? "number" == typeof t
              ...
              : ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)),
                ne[t]
                  ...
                  : "hsl" === t.substr(0, 3)
                  ? ((t = t.match(d)), (s = (Number(t[0]) % 360) / 360), (n = Number(t[1]) / 100), (a = Number(t[2]) / 100), (i = 0.5 >= a ? a * (n + 1) : a + n - a * n), (e = 2 * a - i), t.length > 3 && (t[3] = Number(t[3])), (t[0] = ae(s + 1 / 3, e, i)), (t[1] = ae(s, e, i)), (t[2] = ae(s - 1 / 3, e, i)), t)
      ...
      var he = function (t, e, i, r) {
        ...
        _e =
          ((F._setPluginRatio = function (t) {
            ...
            for (var e, i, r, s, n = this.data, a = n.proxy, o = n.firstMPT, l = 1e-6; o; ) (e = a[o.v]), o.r ? (e = e > 0 ? 0 | (e + 0.5) : 0 | (e - 0.5)) : l > e && e > -l && (e = 0), (o.t[o.p] = e), (o = o._next);
          ...
          for ((-1 !== r.indexOf(",") || -1 !== i.indexOf(",")) && ((R = R.join(" ").replace(D, ", ").split(" ")), (k = k.join(" ").replace(D, ", ").split(" ")), (C = R.length)), C !== k.length && ((R = (n || "").split(" ")), (C = R.length)), a.plugin = l, a.setRatio = u, _ = 0; C > _; _++)
            if (((c = R[_]), (g = k[_]), (T = parseFloat(c)), T || 0 === T)) a.appendXtra("", T, ie(g, T), g.replace(m, ""), A && -1 !== g.indexOf("px"), !0);
              ...
              (S = "," === g.charAt(g.length - 1) ? ")," : ")"),
                ...
                x && !z && 0 === g[3]
                  ? ((a["xs" + a.l] += a.l ? " transparent" : "transparent"), (a.e = a.e.split(k[_]).join("transparent")))
                  : (z || (x = !1),
                    a
      ...
      var ve = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(","),
        ...
        be = function (t, e, i, r) {
          ...
          for (ye ? (s = H(t, Te, e, !0)) : t.currentStyle && ((s = t.currentStyle.filter.match(A)), (s = s && 4 === s.length ? [s[0].substr(4), Number(s[2].substr(4)), Number(s[1].substr(4)), s[3].substr(4), v.x || 0, v.y || 0].join(",") : "")), n = (s || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], o = n.length; --o > -1; ) (l = Number(n[o])), (n[o] = (h = l - (l |= 0)) ? (0 | (h * x + (0 > h ? -0.5 : 0.5))) / x + l : l);
          if (16 === n.length) {
            var S = n[8],
              R = n[9],
              k = n[10],
            ...
            if ((v.zOrigin && ((D = -v.zOrigin), (C = S * D - n[12]), (O = R * D - n[13]), (D = k * D + v.zOrigin - n[14])), !i || r || null == v.rotationX)) {
              var N,
                ...
                K = -b > G || G > b;
              (v.rotationX = G * L),
                G && ((E = Math.cos(-G)), (F = Math.sin(-G)), (N = V * E + S * F), (X = q * E + R * F), (I = Q * E + k * F), (S = V * -F + S * E), (R = q * -F + R * E), (k = Q * -F + k * E), ($ = Z * -F + $ * E), (V = N), (q = X), (Q = I)),
                (G = Math.atan2(S, U)),
                (v.rotationY = G * L),
                G && ((Y = -b > G || G > b), (E = Math.cos(-G)), (F = Math.sin(-G)), (N = U * E - S * F), (X = B * E - R * F), (I = j * E - k * F), (R = B * F + R * E), (k = j * F + k * E), ($ = W * F + $ * E), (U = N), (B = X), (j = I)),
                (G = Math.atan2(B, q)),
                (v.rotation = G * L),
                G && ((z = -b > G || G > b), (E = Math.cos(-G)), (F = Math.sin(-G)), (U = U * E + V * F), (X = B * E + q * F), (q = B * -F + q * E), (Q = j * -F + Q * E), (B = X)),
        ...
        Pe = function (t) {
          ...
          if (p) {
            ...
            var f,
              ...
              b = r.y;
            if (
              (null != r.ox && ((f = (r.oxp ? 0.01 * m * r.ox : r.ox) - m / 2), (d = (r.oyp ? 0.01 * g * r.oy : r.oy) - g / 2), (w += f - (f * o + d * l)), (b += d - (f * h + d * u))),
              v ? ((f = m / 2), (d = g / 2), (x += ", Dx=" + (f - (f * o + d * l) + w) + ", Dy=" + (d - (f * h + d * u) + b) + ")")) : (x += ", sizingMethod='auto expand')"),
        ...
        Se = function () {
          ...
          (u = 1),
            ...
            (g = 1e5),
            (R = P.rotationY * M),
            R && ((v = Math.cos(R)), (y = Math.sin(R)), (l = u * -y), (f = d * -y), (i = t * y), (a = s * y), (u *= v), (d *= v), (t *= v), (s *= v)),
            (R = P.rotationX * M),
            R && ((v = Math.cos(R)), (y = Math.sin(R)), (T = e * v + i * y), (x = n * v + a * y), (w = h * v + u * y), (b = c * v + d * y), (i = e * -y + i * v), (a = n * -y + a * v), (u = h * -y + u * v), (d = c * -y + d * v), (e = T), (n = x), (h = w), (c = b)),
            1 !== A && ((i *= A), (a *= A), (u *= A), (d *= A)),
            1 !== C && ((e *= C), (n *= C), (h *= C), (c *= C)),
            1 !== k && ((t *= k), (s *= k), (l *= k), (f *= k)),
            m && ((_ -= m), (r = i * _), (o = a * _), (_ = u * _ + m)),
            (r = (T = (r += P.x) - (r |= 0)) ? (0 | (T * g + (0 > T ? -0.5 : 0.5))) / g + r : r),
            (o = (T = (o += P.y) - (o |= 0)) ? (0 | (T * g + (0 > T ? -0.5 : 0.5))) / g + o : o),
            (_ = (T = (_ += P.z) - (_ |= 0)) ? (0 | (T * g + (0 > T ? -0.5 : 0.5))) / g + _ : _),
        ...
        Re = function (t) {
          ...
          return a.rotationX || a.rotationY || a.z || a.force3D
            ...
            : (a.rotation || a.skewX ? ((e = a.rotation * M), (i = e - a.skewX * M), (r = 1e5), (s = a.scaleX * r), (n = a.scaleY * r), (l[ye] = "matrix(" + (0 | (Math.cos(e) * s)) / r + "," + (0 | (Math.sin(e) * s)) / r + "," + (0 | (Math.sin(i) * -n)) / r + "," + (0 | (Math.cos(i) * n)) / r + "," + a.x + "," + a.y + ")")) : (l[ye] = "matrix(" + a.scaleX + ",0,0," + a.scaleY + "," + a.x + "," + a.y + ")"), void 0);
        };
      me("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D", {
        parser: function (t, e, i, r, n, a, o) {
          ...
          if ("string" == typeof y.transform && ye) (u = m.cssText), (m[ye] = y.transform), (m.display = "block"), (l = be(t, null, !1)), (m.cssText = u);
            ...
            if (((l = { scaleX: re(null != y.scaleX ? y.scaleX : y.scale, d.scaleX), scaleY: re(null != y.scaleY ? y.scaleY : y.scale, d.scaleY), scaleZ: re(y.scaleZ, d.scaleZ), x: re(y.x, d.x), y: re(y.y, d.y), z: re(y.z, d.z), perspective: re(y.transformPerspective, d.perspective) }), (c = y.directionalRotation), null != c))
            ...
            (l.rotation = se("rotation" in y ? y.rotation : "shortRotation" in y ? y.shortRotation + "_short" : "rotationZ" in y ? y.rotationZ : d.rotation, d.rotation, "rotation", T)),
              we && ((l.rotationX = se("rotationX" in y ? y.rotationX : "shortRotationX" in y ? y.shortRotationX + "_short" : d.rotationX || 0, d.rotationX, "rotationX", T)), (l.rotationY = se("rotationY" in y ? y.rotationY : "shortRotationY" in y ? y.shortRotationY + "_short" : d.rotationY || 0, d.rotationY, "rotationY", T))),
          ...
          return (
            (_ = y.transformOrigin),
            (_ || (we && p && d.zOrigin)) &&
              (ye ? ((f = !0), (i = xe), (_ = (_ || H(t, i, s, !1, "50% 50%")) + ""), (n = new pe(m, i, 0, 0, n, -1, "transformOrigin")), (n.b = m[i]), (n.plugin = a), we ? ((u = d.zOrigin), (_ = _.split(" ")), (d.zOrigin = (_.length > 2 && (0 === u || "0px" !== _[2]) ? parseFloat(_[2]) : u) || 0), (n.xs0 = n.e = m[i] = _[0] + " " + (_[1] || "50%") + " 0px"), (n = new pe(d, "zOrigin", 0, 0, n, -1, n.n)), (n.b = u), (n.xs0 = n.e = d.zOrigin)) : (n.xs0 = n.e = m[i] = _)) : ee(_ + "", d)),
          ...
          parser: function (t, e, i, n, a) {
            ...
            for (d = parseFloat(t.offsetWidth), m = parseFloat(t.offsetHeight), o = e.split(" "), l = 0; b.length > l; l++)
              this.p.indexOf("border") && (b[l] = V(b[l])),
                ...
                "" === g && (g = r[i] || v),
                g !== v && ((T = Q(t, "borderLeft", f, v)), (x = Q(t, "borderTop", f, v)), "%" === g ? ((_ = 100 * (T / d) + "%"), (u = 100 * (x / m) + "%")) : "em" === g ? ((w = Q(t, "borderLeft", 1, "em")), (_ = T / w + "em"), (u = x / w + "em")) : ((_ = T + "px"), (u = x + "px")), y && ((p = parseFloat(_) + c + g), (h = parseFloat(u) + c + g))),
          ...
          for (a in e)
            (f = e[a]),
              ...
              l
                ...
                : ((p = H(t, a, s) + ""),
                  (m = "string" == typeof f),
                  "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || (m && b.test(f))
                    ? (m || ((f = oe(f)), (f = (f.length > 3 ? "rgba(" : "rgb(") + f.join(",") + ")")), (i = fe(v, a, p, f, !0, "transparent", i, 0, n)))
                    : !m || (-1 === f.indexOf(" ") && -1 === f.indexOf(","))
                    ? ((u = parseFloat(p)),
                      (c = u || 0 === u ? p.substr((u + "").length) : ""),
                      ("" === p || "auto" === p) && ("width" === a || "height" === a ? ((u = te(t, a, s)), (c = "px")) : "left" === a || "top" === a ? ((u = Z(t, a, s)), (c = "px")) : ((u = "opacity" !== a ? 0 : 1), (c = ""))),
                      (g = m && "=" === f.charAt(1)),
                      g ? ((_ = parseInt(f.charAt(0) + "1", 10)), (f = f.substr(2)), (_ *= parseFloat(f)), (d = f.replace(y, ""))) : ((_ = parseFloat(f)), (d = m ? f.substr((_ + "").length) || "" : "")),
                      "" === d && (d = a in r ? r[a] : c),
                      (f = _ || 0 === _ ? (g ? _ + u : _) + d : e[a]),
                      c !== d && "" !== d && (_ || 0 === _) && (u || 0 === u) && ((u = Q(t, a, u, c)), "%" === d ? ((u /= Q(t, a, 100, "%") / 100), e.strictUnits !== !0 && (p = u + "%")) : "em" === d ? (u /= Q(t, a, 1, "em")) : ((_ = Q(t, a, _, d)), (d = "px")), g && (_ || 0 === _) && (f = _ + u + d)),
                      g && (_ += u),
                      (!u && 0 !== u) || (!_ && 0 !== _) ? (void 0 !== v[a] && (f || ("NaN" != f + "" && null != f)) ? ((i = new pe(v, a, _ || u || 0, 0, i, -1, a, !1, 0, p, f)), (i.xs0 = "none" !== f || ("display" !== a && -1 === a.indexOf("Style")) ? f : p)) : B("invalid " + a + " tween value: " + e[a])) : ((i = new pe(v, a, u, _ - u, i, 0, a, h !== !1 && ("px" === d || "zIndex" === a), 0, p, f)), (i.xs0 = d)))
        ...
        (l.setRatio = function (t) {
          ...
          if (1 !== t || (this._tween._time !== this._tween._duration && 0 !== this._tween._time))
            if (t || (this._tween._time !== this._tween._duration && 0 !== this._tween._time) || this._tween._rawPrevTime === -1e-6)
              for (; s; ) {
                if (((e = s.c * t + s.s), s.r ? (e = e > 0 ? 0 | (e + 0.5) : 0 | (e - 0.5)) : n > e && e > -n && (e = 0), s.type))
                  if (1 === s.type)
