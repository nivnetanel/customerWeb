...
(function (e, t) {
  ...
  function l(e, t, n) {
    TweenLite.to(e.find(".tp-thumbcontainer"), 0.2, { left: t, ease: Power3.easeOut, overwrite: "auto" });
  }
  function c(t, n) {
      ...
      for (var S = 0; S < n.slots; S++) {
        ...
        if (o(8)) {
          s.find(".slot ")
            .last()
            .find(".slotslide")
            .append('<img class="ieeightfallbackimage" src="' + w + '" style="width:100%">');
          E(s, n);
        }
      }
    } else {
  ...
  function L(n, r) {
    ...
    if (l == 0) {
      ...
      f.find(".slotslide").each(function (t) {
        ...
        TweenLite.fromTo(
          s,
          N / 600,
          { opacity: 0, top: 0 - r.sloth, left: 0 - r.slotw, rotation: r.rotate },
          {
            opacity: 1,
    ...
    if (l == 4 || l == 5) {
      ...
      a.find(".slotslide").each(function (t) {
        ...
        TweenLite.to(n, O * 3, { transformPerspective: 600, top: 0 + r.height, opacity: 0.5, rotation: r.rotate, ease: Power2.easeInOut, delay: i });
      });
      f.find(".slotslide").each(function (t) {
        var s = e(this);
        var o = (t * O) / r.slots;
        ...
        TweenLite.fromTo(
          s,
          O * 3,
          { top: 0 - r.height, opacity: 0.5, rotation: r.rotate, transformPerspective: 600 },
          {
            top: 0,
            opacity: 1,
            rotation: 0,
    ...
    if (l == 6) {
      ...
      f.find(".slotslide").each(function (t) {
        ...
        TweenLite.fromTo(
          s,
          (N + o) / 1e3,
          { top: 0 - r.height, opacity: 1, rotation: r.rotate, transformPerspective: 600 },
          {
            top: 0,
            opacity: 1,
            rotation: 0,
    ...
    if (l == 12 || l == 13 || l == 14 || l == 15) {
      ...
      if (d != 1) {
        if (l == 12) TweenLite.to($, V, { left: 0 - D + "px", scale: q, opacity: I, rotation: r.rotate, ease: U });
    ...
    if (l == 16) {
      ...
      if (i.html() != null) TweenLite.fromTo(u, (N - 200) / 1e3, { opacity: 0, scale: 0.8, x: r.width * Z, y: P * et, rotation: Y, transformPerspective: 600, transformOrigin: "center center" }, { rotation: 0, scale: 1, x: 0, y: 0, opacity: 1, ease: Power2.easeInOut });
    ...
    if (l == 19 || l == 22) {
      ...
      f.find(".slotslide").each(function (t) {
        ...
        TweenLite.fromTo(
          s,
          N / 1e3,
          { left: 0, rotationY: r.rotate, opacity: I, top: 0, scale: 0.8, transformPerspective: 600, transformOrigin: ot, rotationX: st },
          {
            left: 0,
            rotationY: 0,
            opacity: 1,
      ...
      a.find(".slotslide").each(function (t) {
        ...
        TweenLite.fromTo(
          s,
          N / 1e3,
          { opacity: 1, rotationY: 0, top: 0, z: 0, scale: 1, transformPerspective: 600, transformOrigin: ot, rotationX: 0 },
          {
            opacity: 1,
            rotationY: r.rotate,
            top: 0,
        ...
        TweenLite.to(s, 0.1, { opacity: 0, delay: (t * 50) / 1e3 + (N / 1e3 - N / 1e4) });
      });
    }
    if (l == 20) {
      f.find(".defaultimg").css({ opacity: 0 });
      ...
      f.find(".slotslide").each(function (t) {
        ...
        TweenLite.fromTo(
          s,
          N / 1e3,
          { rotationX: 40, z: -600, opacity: I, top: 0, scale: 1, transformPerspective: 600, transformOrigin: ot, rotationY: st },
          {
            rotationX: 0,
            opacity: 1,
            top: 0,
      ...
      a.find(".slotslide").each(function (t) {
        ...
        TweenLite.fromTo(
          s,
          N / 1e3,
          { opacity: 1, rotationX: 0, top: 0, z: 0, scale: 1, left: 0, transformPerspective: 600, transformOrigin: c, rotationY: 0 },
          {
            opacity: 1,
            rotationX: 40,
            top: 0,
    ...
    if (l == 21 || l == 25) {
      ...
      f.find(".slotslide").each(function (t) {
        ...
        TweenLite.fromTo(
          s,
          N / 1500,
          { left: 0, rotationX: rot2, z: 0, opacity: 0, top: 0, scale: 1, transformPerspective: 600, transformOrigin: ot, rotationY: st },
          {
            left: 0,
            rotationX: 0,
            top: 0,
        ...
        TweenLite.to(s, 0.3, { opacity: 1, delay: (t * 100) / 1e3 + (N * 0.2) / 2e3 + N / 1e4 });
      });
      if (T != 1) {
        var ut = -r.width;
        var st = 90;
      ...
      a.find(".slotslide").each(function (t) {
        ...
        TweenLite.to(n, 0.2, { opacity: 0, delay: (t * 50) / 1e3 + (N / 3e3 - N / 1e4) });
      });
    }
    if (l == 23 || l == 24) {
      f.find(".defaultimg").css({ opacity: 0 });
      ...
      f.find(".slotslide").each(function (t) {
        ...
        TweenLite.fromTo(
          s,
          N / 1e3,
          { left: at, rotationX: r.rotate, opacity: I, top: 0, scale: 1, transformPerspective: 600, transformOrigin: ot, rotationY: st },
          {
            left: 0,
            rotationX: 0,
            opacity: 1,
      ...
      a.find(".slotslide").each(function (t) {
        ...
        TweenLite.fromTo(
          s,
          N / 1e3,
          { left: 0, opacity: 1, rotationX: 0, top: 0, z: 0, scale: 1, transformPerspective: 600, transformOrigin: ot, rotationY: 0 },
          {
            left: at,
            opacity: 1,
            rotationX: r.rotate,
    ...
    f.find(".defaultimg").each(function () {
      ...
      t.data(
        ...
        TweenLite.fromTo(
          t,
          b,
          { transformPerspective: 1200, backgroundSize: m, z: 0, backgroundPosition: l, rotationZ: d },
          {
            yoyo: 2,
            rotationZ: v,
            ease: y,
      ...
      if (l == 0) {
              ...
              var o = setInterval(function () {
                ...
                if (n != t && n.hasClass("video-js")) {
                  ...
                  if (f.data("autoplay") == true) {
                    ...
                    videojs(i).ready(function () {
                      var e = this;
                      if (n.data("loadedmetadata") == 1 || n.data("canplay") == 1) if (f.data("forcerewind") == "on") e.currentTime(0);
                      n.data(
                        "timerplay",
                        setTimeout(function () {
        ...
        if (!i) {
          ...
          if (f.data("splitin") == "chars" || f.data("splitin") == "words" || f.data("splitin") == "lines" || f.data("splitout") == "chars" || f.data("splitout") == "words" || f.data("splitout") == "lines") {
            if (f.find("a").length > 0) f.data("mySplitText", new SplitText(f.find("a"), { type: "lines,words,chars", charsClass: "tp-splitted", wordsClass: "tp-splitted", linesClass: "tp-splitted" }));
          ...
          if (f.hasClass("customin")) {
            if (B != f) H.add(TweenLite.set(f, { opacity: 1, scaleX: 1, scaleY: 1, rotationX: 0, rotationY: 0, rotationZ: 0, skewX: 0, skewY: 0, z: 0, x: 0, y: 0, visibility: "visible", opacity: 1, delay: 0, overwrite: "all" }));
            F.visibility = "hidden";
  ...
  var t = e.GreenSockGlobals || e,
    ...
    l = function (e) {
      var t,
        ...
        s = e.length;
      for (t = 0; s > t; t++)
        if (((n = e[t]), f(n))) for (r = n.length, r = 0; n.length > r; r++) i.push(n[r]);
        else i.push(n);
      return i;
    },
    ...
    g = function (e, t, n, r, u) {
      ...
      for (d = 0; U > d; d++)
        (b = y[d]),
          (l = b.parentNode === e),
          "BR" !== b.nodeName
            ? (O && ((S = b.style), L || l || ((b._x += b.parentNode._x), (b._y += b.parentNode._y)), (S.left = b._x + "px"), (S.top = b._y + "px"), (S.position = "absolute"), (S.display = "block"), (S.width = b._w + 1 + "px"), (S.height = b._h + "px")), L ? (l ? r.push(b) : A && n.push(b)) : l ? (e.removeChild(b), y.splice(d--, 1), U--) : !l && A && ((w = !k && !O && b.nextSibling), e.appendChild(b), w || e.appendChild(s.createTextNode(" ")), n.push(b)))
            : k || O
